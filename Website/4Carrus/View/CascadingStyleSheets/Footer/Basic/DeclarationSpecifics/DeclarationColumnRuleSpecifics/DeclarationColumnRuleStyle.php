...
/**
 * Description of DeclarationColumnRuleStyle
 *
 * @author Silvio
 */
class DeclarationColumnRuleStyle extends DeclarationColumnRule {

    //Constructor
    //   instantiation: 
    //      $declaration = DeclarationColor::DeclarationColorWithStringHexColorValue($stringHexColorValue);
    public static function DeclarationColumnRuleStyleWithStringValue($stringValue) {
        $instance = new parent("column-rule-style", $stringValue); //arrumar
        return $instance;
    }
