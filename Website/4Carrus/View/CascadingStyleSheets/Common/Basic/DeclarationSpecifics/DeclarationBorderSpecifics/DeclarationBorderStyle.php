 ...
 * @author Judah
 */
class DeclarationBorderStyle extends DeclarationBorder {

    //Constructor
    //   instantiation: 
    //      $declaration = DeclarationBackgroundColor::DeclarationBackgroundColorWithStringHexColorValue($stringHexColorValue);
    public static function DeclarationBorderStyleWithStringValue($stringValue) {
        $instance = new parent("border-style", $stringValue); //arrumar
        return $instance;
    }
