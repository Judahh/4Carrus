...
class DeclarationBorderImageSource extends DeclarationBorderImage {
    ...
    public static function DeclarationBorderSourceWithStringValue($stringValue) {
        $instance = new parent("border-image-source", $stringValue); //arrumar
        return $instance;
    }

    public static function DeclarationBorderSourceWithBasicUniformResourceLocator($basicUniformResourceLocator) {
