 ...
 * @author Judah
 */
class DeclarationBorderRightStyle extends DeclarationBorderRight {

    //Constructor
    //   instantiation: 
    //      $declaration = DeclarationBackgroundColor::DeclarationBackgroundColorWithStringHexColorValue($stringHexColorValue);
    public static function DeclarationBorderRightStyleWithStringValue($stringValue) {
        $instance = new parent("border-right-style", $stringValue); //arrumar
        return $instance;
    }
