 ...
 * @author Judah
 */
class DeclarationBorderBottomStyle extends DeclarationBorderBottom {

    //Constructor
    //   instantiation: 
    //      $declaration = DeclarationBackgroundColor::DeclarationBackgroundColorWithStringHexColorValue($stringHexColorValue);
    public static function DeclarationBorderBottomStyleWithStringValue($stringValue) {
        $instance = new parent("border-bottom-style", $stringValue); //arrumar
        return $instance;
    }
