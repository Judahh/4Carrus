 ...
 * @author Judah
 */
class DeclarationBorderTopStyle extends DeclarationBorderTop {

    //Constructor
    //   instantiation: 
    //      $declaration = DeclarationBackgroundColor::DeclarationBackgroundColorWithStringHexColorValue($stringHexColorValue);
    public static function DeclarationBorderTopStyleWithStringValue($stringValue) {
        $instance = new parent("border-top-style", $stringValue); //arrumar
        return $instance;
    }
