 ...
 * @author Judah
 */
class DeclarationBackgroundClip extends DeclarationBackground {

    //Constructor
    //   instantiation: 
    //      $declaration = DeclarationBackgroundColor::DeclarationBackgroundColorWithStringHexColorValue($stringHexColorValue);
    public static function DeclarationBackgroundClipWithStringValue($stringValue) {
        $instance = new parent("background-clip", $stringValue); //arrumar
        return $instance;
    }
